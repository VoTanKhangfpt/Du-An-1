            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <?php if(is_array($listuserById)): extract($listuserById)?>
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="topic-name" class="col-form-label">Tên tài khoản:</label>
                                        <input value="<?=isset($_POST['ten']) ? $_POST['ten'] : $ten?>"  type="text" class="form-control" name="ten" placeholder="Tên tài khoản">
                                    </div>
                                    <div class="mb-3">
                                        <label for="topic-name" class="col-form-label">Email:</label>
                                        <input value="<?=isset($_POST['email']) ? $_POST['email'] : $email?>" class="form-control" name="email" placeholder="Email">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input value="<?=isset($_POST['sodienthoai']) ? $_POST['sodienthoai'] : $sodienthoai?>" type="text" class="form-control" name="sodienthoai" placeholder="Số điện thoại">
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input value="<?=isset($_POST['matkhau']) ? $_POST['matkhau'] : $matkhau?>" type="password" class="form-control" name="matkhau" placeholder="Mật khẩu">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-group">
                                            <label for="topic-name" class="col-form-label">
                                                <input <?php if($quyen==0) echo 'checked'; else echo '';?> type="radio" name="quyen" id="" value="0">
                                                <span>User</span>
                                            </label>
                                            <label for="topic-name" class="col-form-label">
                                                <input <?php if($quyen==1) echo 'checked'; else echo '';?> type="radio" name="quyen" id="" value="1">
                                                <span>Admin</span>
                                            </label>
